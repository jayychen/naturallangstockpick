...
disclaimer.addEventListener('click', () => {
  infoContainer.innerHTML = `<div class="alert alert-secondary">DISCLAIMER: The information provided on this website is for educational and informational purposes only and should not be considered as investment advice. The website does not make any representation or warranty as to the accuracy, completeness, or timeliness of the information on this site. Any reliance you place on such information is therefore strictly at your own risk. The website shall not be liable for any investment loss, including without limitation, indirect or consequential loss or damage, or any loss or damage whatsoever arising from the use of this website.</div>`;
});
